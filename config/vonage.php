...
return [
    ...
    */
    ...
    'application_id' => function_exists('env') ? env('VONAGE_APPLICATION_ID', '') : '', // Vonage Application ID (UUID format)
    ...
    */
    ...
    'whatsapp_number'  => function_exists('env') ? env('VONAGE_WHATSAPP_NUMBER', '') : '', // WhatsApp sender number (E.164 format)
