...
class CommunicationTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super-admin.communication-templates.index', compact('templates', 'stats'));
    }
    ...
    {
        return view('super-admin.communication-templates.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        Log::info('Communication template created', [
        ...
        return redirect()
            ->route('super-admin.communication-templates.index')
    ...
    public function show(CommunicationTemplate $communicationTemplate)
    {
        ...
        return view('super-admin.communication-templates.show', compact('communicationTemplate'));
    }
    ...
    {
        return view('super-admin.communication-templates.edit', compact('communicationTemplate'));
    }
    ...
    public function update(Request $request, CommunicationTemplate $communicationTemplate)
    {
        ...
        Log::info('Communication template updated', [
        ...
        return redirect()
            ->route('super-admin.communication-templates.show', $communicationTemplate)
    ...
    public function destroy(CommunicationTemplate $communicationTemplate)
    {
        ...
        Log::info('Communication template deleted', [
            'template_id' => $communicationTemplate->id,
            'template_name' => $communicationTemplate->name,
            'admin_id' => $admin->id,
            'admin_email' => $admin->email,
