...
class RegistrationController extends Controller
{
    ...
    public function register(Request $request)
    {
        $validated = $request->validate([
            ...
            'is_consultant' => 'required|accepted',
            ...
            'is_consultant.required' => 'Please confirm if you are a consultant in your specialization.',
            'is_consultant.accepted' => 'You must be a consultant in your specialization to register.',
        ...
        $doctor = Doctor::create([
            ...
            'is_consultant' => $request->has('is_consultant') && $request->is_consultant == '1',
            'can_provide_second_opinion' => $request->has('is_consultant') && $request->is_consultant == '1',
