...
class CanvasserAccountCreated extends Mailable implements ShouldQueue
{
    ...
    public function __construct(Canvasser $canvasser, string $password, string $adminName)
    {
        ...
        $templateData = [
            ...
            'login_link' => route('canvasser.login'),
        ];

        // Try to get template from CommunicationTemplate system
        $rendered = EmailTemplateService::render('CanvasserAccountCreated', $templateData);
        ...
        if ($rendered) {
            ...
            $this->templateSubject = 'Your Canvasser Account Has Been Created - DoctorOnTap';
        }
    }
