                ...
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="hidden md:flex flex-1 max-w-md mx-8">
                        <form action="{{ route('patient.search') }}" method="GET" class="relative w-full">
                            <input type="text" name="q" value="{{ request('q') }}" placeholder="Search records, doctors..." class="w-full pl-10 pr-4 py-2 bg-white bg-opacity-20 backdrop-blur-sm border border-white border-opacity-30 rounded-lg focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent text-sm text-white placeholder-white placeholder-opacity-70">
                            <button type="submit" class="absolute left-3 top-1/2 transform -translate-y-1/2 text-white text-opacity-70 hover:text-white transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
