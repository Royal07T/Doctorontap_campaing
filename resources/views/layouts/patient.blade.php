        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col"
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-2 sidebar-nav" style="min-height: 0; flex: 1 1 auto; -webkit-overflow-scrolling: touch;">
                ...
                <a href="{{ route('patient.settings') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg font-medium transition-all {{ request()->routeIs('patient.settings') || request()->routeIs('patient.profile') ? 'text-white purple-gradient' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="purple-gradient shadow-lg border-b border-purple-700 z-10">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="hidden md:flex flex-1 max-w-md mx-8">
                        <form action="{{ route('patient.search') }}" method="GET" class="relative w-full">
                            <input type="text" name="q" value="{{ request('q') }}" placeholder="Search records, doctors..." class="w-full pl-10 pr-4 py-2 bg-white bg-opacity-95 backdrop-blur-sm border border-white border-opacity-30 rounded-lg focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent text-sm text-gray-900 placeholder-gray-500">
                            <button type="submit" class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            ...
                            <div x-show="open" 
                                 ...
                                 style="display: none;">
                                <a href="{{ route('patient.settings') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    <span class="font-medium">Profile</span>
                                </a>
                                <a href="{{ route('patient.settings') }}#security" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
