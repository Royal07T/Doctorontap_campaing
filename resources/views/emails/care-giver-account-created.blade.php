...
<head>
    ...
    <title>Your Care Giver Account | DoctorOnTap</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Your Care Giver Account Has Been Created</p>
        </div>
        ...
        <div class="content">
            ...
            <p>Great news! Your care giver account has been successfully created by <strong>{{ $adminName }}</strong>. You're now part of the DoctorOnTap healthcare team!</p>
            ...
            <div class="credentials-box">
                ...
                <div class="credential-item">
                    ...
                    <div class="credential-value">{{ $careGiver->email }}</div>
                </div>
                <div class="credential-item">
                ...
                <div class="credential-item">
                    ...
                    <div class="credential-value">{{ route('care_giver.login') }}</div>
                </div>
            </div>
            ...
            <div class="steps">
                ...
                <div class="step">
                    ...
                    <div>
                        ...
                        Use the credentials above to access your care giver portal.
                    </div>
                </div>
                ...
                <div class="step">
                    ...
                    <div>
                        <strong>Start Providing Care</strong><br>
            ...
            <div class="info-box">
                ...
                <strong>Name:</strong> {{ $careGiver->name }}<br>
                <strong>Email:</strong> {{ $careGiver->email }}<br>
                <strong>Phone:</strong> {{ $careGiver->phone ?? 'N/A' }}<br>
                <strong>Role:</strong> Care Giver<br>
