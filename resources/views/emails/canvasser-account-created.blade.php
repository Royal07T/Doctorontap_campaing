...
<head>
    ...
    <title>Your Canvasser Account | DoctorOnTap</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Your Canvasser Account Has Been Created</p>
        </div>

        <!-- Content -->
        <div class="content">
            <h2>Hello {{ $canvasser->name }}! 👋</h2>
            
            <p>Great news! Your canvasser account has been successfully created by <strong>{{ $adminName }}</strong>. You're now part of the DoctorOnTap team!</p>
            ...
            <div class="credentials-box">
                ...
                <div class="credential-item">
                    ...
                    <div class="credential-value">{{ $canvasser->email }}</div>
                </div>
                <div class="credential-item">
                ...
                <div class="credential-item">
                    ...
                    <div class="credential-value">{{ route('canvasser.login') }}</div>
                </div>
            </div>
            ...
            <div class="steps">
                ...
                <div class="step">
                    ...
                    <div>
                        ...
                        Use the credentials above to access your canvasser portal.
                    </div>
                </div>
                ...
                <div class="step">
                    ...
                    <div>
                        <strong>Start Registering Patients</strong><br>
                        Begin your journey helping patients access quality healthcare.
                    </div>
                </div>
            </div>
            ...
            <div style="text-align: center;">
                <a href="{{ route('canvasser.verification.verify', ['id' => $canvasser->id, 'hash' => sha1($canvasser->email)]) }}" 
                   class="cta-button">
            ...
            <div class="info-box">
                ...
                <strong>Name:</strong> {{ $canvasser->name }}<br>
                <strong>Email:</strong> {{ $canvasser->email }}<br>
                <strong>Phone:</strong> {{ $canvasser->phone }}<br>
                <strong>Role:</strong> Canvasser<br>
