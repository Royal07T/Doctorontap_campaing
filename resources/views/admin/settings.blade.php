                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
                        <div class="border-b border-gray-200 p-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Pricing Settings</h2>
                                    <p class="text-xs text-gray-600 mt-0.5">Configure default consultation fees for all doctors</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.settings.update') }}" class="p-5 space-y-4">
                            ...
                            <div>
                                <label for="default_consultation_fee" class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">
                                    Default Consultation Fee (₦)
                                </label>
                                <div class="relative">
                                    ...
                                    <input type="number"
                                           ...
                                           min="0"
                                           step="0.01"
                                           class="w-full pl-8 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition @error('default_consultation_fee') border-red-500 @enderror">
                                </div>
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <h3 class="text-xs font-semibold text-gray-900 uppercase tracking-wide mb-3">Multi-Patient Booking Pricing</h3>
                                
                                <div class="mb-3">
                                <label for="multi_patient_booking_fee" class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number"
                                           ...
                                           min="0"
                                           step="0.01"
                                           class="w-full pl-8 pr-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition @error('multi_patient_booking_fee') border-red-500 @enderror">
                                </div>
                                <p class="mt-1.5 text-xs text-gray-600">
                                ...
                                <div>
                                    <label for="additional_child_discount_percentage" class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">
                                    ...
                                    <div class="relative">
                                        <input type="number"
                                               ...
                                               max="100"
                                               step="0.01"
                                               class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition @error('additional_child_discount_percentage') border-red-500 @enderror">
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <label for="doctor_payment_percentage" class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">
                                    Doctor Payment Percentage (%)
                                </label>
                                <div class="relative">
                                    <input type="number"
                                           ...
                                           max="100"
                                           step="0.01"
                                           class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition @error('doctor_payment_percentage') border-red-500 @enderror">
                                    <span class="absolute right-3 top-2.5 text-xs text-gray-500">%</span>
                                </div>
                                <p class="mt-1.5 text-xs text-gray-600">
                                ...
                                <div class="mt-2 bg-purple-50 border border-purple-200 rounded-lg p-3">
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="use_default_fee_for_all"
                                               ...
                                               class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-200">
                                    </div>
                                    <div class="ml-3">
                                        <label for="use_default_fee_for_all" class="text-xs font-semibold text-gray-900">
                            ...
                            <!-- Current Statistics -->
                            <div class="border-t border-gray-200 pt-4">
                                <h3 class="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3">Current Statistics</h3>
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-3">
                                        ...
                                        <div class="text-lg font-bold text-purple-900">{{ \App\Models\Doctor::where('use_default_fee', true)->count() }}</div>
                                    </div>
                                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                        <div class="text-xs text-blue-600 font-medium uppercase tracking-wide mb-1">Doctors with Custom Fee</div>
                                        <div class="text-lg font-bold text-blue-900">{{ \App\Models\Doctor::where('use_default_fee', false)->count() }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border-t border-gray-200 pt-4 flex justify-end">
                                <button type="submit"
                                        class="inline-flex items-center gap-1.5 px-4 py-2.5 text-xs font-semibold text-white purple-gradient rounded-lg hover:opacity-90 transition">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
                        <div class="border-b border-gray-200 p-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Security Alerts</h2>
                                    <p class="text-xs text-gray-600 mt-0.5">Configure email notifications for security events</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="security_alerts_enabled"
                                           ...
                                           class="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-200">
                                </div>
                                <div class="ml-3">
                                    <label for="security_alerts_enabled" class="text-xs font-semibold text-gray-900">
