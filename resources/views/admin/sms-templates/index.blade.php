...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false, pageLoading: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            @include('admin.shared.header', ['title' => 'SMS Templates'])
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
                        <div class="flex-1 flex items-center space-x-3">
                            <form method="GET" class="flex items-center space-x-3">
                                ...
                                <a href="{{ route('admin.sms-templates.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                                    Clear
                                </a>
                            </form>
                        </div>

                        <a href="{{ route('admin.sms-templates.create') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">
                            ...
                            @forelse($templates as $template)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-xs text-gray-500">{{ Str::limit($template->content, 50) }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <form action="{{ route('admin.sms-templates.toggle-status', $template) }}" method="POST" class="inline">
                                            @csrf
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        <a href="{{ route('admin.sms-templates.show', $template) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                        <a href="{{ route('admin.sms-templates.edit', $template) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        <form action="{{ route('admin.sms-templates.duplicate', $template) }}" method="POST" class="inline">
                                            @csrf
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                        No templates found. <a href="{{ route('admin.sms-templates.create') }}" class="text-purple-600 hover:text-purple-900">Create one now</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
