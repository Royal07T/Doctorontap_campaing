...
<head>
    ...
    <title>Create SMS Template - Admin</title>
...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            @include('admin.shared.header', ['title' => 'Create SMS Template'])
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Create New SMS Template</h2>
                        ...
                        <form action="{{ route('admin.sms-templates.store') }}" method="POST" x-data="templateForm()">
                            @csrf
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="content" name="content" rows="6" required
                                    ...
                                    placeholder="Type your message here. Use {variable_name} for dynamic content.&#10;&#10;Example: Hello {first_name}, your appointment with {doctor_name} is on {date} at {time}.">{{ old('content') }}</textarea>
                            ...
                            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm text-blue-800">
                                    ...
                                    <code class="bg-white px-2 py-1 rounded">{reference}</code>
                                    <code class="bg-white px-2 py-1 rounded">{amount}</code>
                                    <code class="bg-white px-2 py-1 rounded">{link}</code>
                                    <code class="bg-white px-2 py-1 rounded">{company}</code>
                                </div>
                                <p class="mt-2 text-xs text-blue-700">Variables will be automatically detected and replaced when sending SMS.</p>
                            </div>
