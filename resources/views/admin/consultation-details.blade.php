        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Payout Reference</label>
                            <p class="text-xs text-gray-900 font-mono font-semibold">{{ $payoutInfo['payment_reference'] }}</p>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Payout Status</label>
                            <span class="inline-flex px-2.5 py-1 rounded-full text-xs font-semibold
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Doctor Amount</label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">KoraPay Reference</label>
                            <p class="text-xs text-gray-900 font-mono">{{ $payoutInfo['korapay_reference'] }}</p>
                        </div>
                        @endif
                        @if($payoutInfo['korapay_status'])
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">KoraPay Status</label>
                            <span class="inline-flex px-2.5 py-1 rounded-full text-xs font-semibold
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Bank Account</label>
