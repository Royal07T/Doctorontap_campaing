                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-6">
                    ...
                    <form method="GET" action="{{ route('admin.admin-users') }}" class="grid grid-cols-1 md:grid-cols-5 gap-3">
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            <a href="{{ route('admin.admin-users') }}" class="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 text-xs font-semibold text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
