...
<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col sidebar-scrollable"
    ...
    <nav class="p-4 space-y-2 flex-1 overflow-y-auto">
        <a href="{{ admin_route('admin.dashboard') }}" 
        ...
        <a href="{{ admin_route('admin.consultations') }}"
        ...
        <a href="{{ admin_route('admin.patients') }}"
        ...
        <a href="{{ admin_route('admin.payments') }}"
        ...
        <a href="{{ admin_route('admin.doctor-payments') }}"
        ...
        <a href="{{ admin_route('admin.doctors') }}"
        ...
        <a href="{{ admin_route('admin.doctor-registrations') }}"
        ...
        <a href="{{ admin_route('admin.admin-users') }}"
        ...
        <a href="{{ admin_route('admin.canvassers') }}"
        ...
        <a href="{{ admin_route('admin.canvasser-patients') }}"
        ...
        <a href="{{ admin_route('admin.nurses') }}"
        ...
        <a href="{{ admin_route('admin.vital-signs') }}"
        ...
        <a href="{{ admin_route('admin.reviews') }}"
        ...
        <a href="{{ admin_route('admin.security') }}"
        ...
        <a href="{{ admin_route('admin.settings') }}"
        ...
        <form method="POST" action="{{ admin_route('admin.logout') }}">
            @csrf
