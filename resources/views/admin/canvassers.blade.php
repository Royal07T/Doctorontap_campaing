...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false, pageLoading: false }">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-6">
                    ...
                    <form method="GET" action="{{ admin_route('admin.canvassers') }}" class="grid grid-cols-1 md:grid-cols-5 gap-3">
                        <!-- Search -->
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            <a href="{{ admin_route('admin.canvassers') }}" class="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 text-xs font-semibold text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        ...
        function openAddModal() {
            ...
            document.getElementById('form').action = '{{ admin_route('admin.canvassers.store') }}';
