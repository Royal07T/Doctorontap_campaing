...
@php
    $inputId = $id ?? $name;
    $baseClass = 'w-full h-12 px-4 pr-12 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/25 focus:border-violet-500 bg-white transition-all duration-200 ';
    $normalClass = 'border-slate-200 focus:border-violet-500 focus:ring-violet-500/25 ';
