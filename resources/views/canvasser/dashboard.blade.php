...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0"
            ...
            <!-- Sidebar Header -->
            <div class="blue-gradient p-5 flex items-center justify-between">
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('canvasser.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 text-white blue-gradient rounded-lg font-medium transition-all">
                ...
                <a href="{{ url('/') }}" target="_blank" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-blue-50 rounded-lg font-medium transition-all hover:text-blue-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <!-- Top Header -->
            <header class="blue-gradient shadow-lg z-10">
                <div class="flex items-center justify-between px-6 py-6">
                    <div class="flex items-center space-x-4">
                        <button @click="sidebarOpen = true" class="lg:hidden text-white hover:text-blue-200 focus:outline-none">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-blue-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-blue-600">{{ $stats['total_consultations'] }}</p>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
                    <div class="max-w-2xl mx-auto">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 mb-2">Welcome, {{ Auth::guard('canvasser')->user()->name }}!</h2>
                        <p class="text-gray-600">You're logged in to your canvasser dashboard. More features will be available soon.</p>
                    </div>
                </div>
            </main>
        </div>
