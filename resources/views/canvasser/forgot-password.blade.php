...
<head>
    ...
    <title>Forgot Password - DoctorOnTap Canvasser</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-white">Canvasser Password Reset</h1>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <form method="POST" action="{{ route('canvasser.password.email') }}">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="email" 
                           ...
                           required 
                           autofocus
                           placeholder="canvasser@doctorontap.com"
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-purple-900 bg-opacity-30 px-4 py-2 rounded-lg">
                ...
                <p class="text-purple-100 text-xs">
                    Secure canvasser area • Check your email for instructions
                </p>
            </div>
        </div>
    </div>
