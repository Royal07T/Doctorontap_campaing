...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('patient.support-tickets.store') }}">
            @csrf
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('patient.support-tickets.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 font-semibold">
                    Cancel
                </a>
