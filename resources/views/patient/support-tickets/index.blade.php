...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('patient.support-tickets.create') }}" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-semibold transition-colors flex items-center gap-2">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 mb-6">
    <form method="GET" action="{{ route('patient.support-tickets.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
        ...
        <div class="md:col-span-3 flex gap-2">
            <button type="submit" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-semibold">Filter</button>
            <a href="{{ route('patient.support-tickets.index') }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Clear</a>
        </div>
    </form>
</div>
...
<div class="space-y-4">
    ...
    <a href="{{ route('patient.support-tickets.show', $ticket) }}" class="block bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all p-5">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
    ...
    <a href="{{ route('patient.support-tickets.create') }}" class="inline-block px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-semibold">
