...
<head>
    ...
    <title>Patient Login - DoctorOnTap</title>
...
<body class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false }">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-white">Patient Portal</h1>
            <p class="text-purple-200 mt-1 text-sm">Sign in to access your health records</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <form method="POST" action="{{ route('patient.login.post') }}">
                ...
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <a href="{{ route('patient.forgot-password') }}" class="text-xs text-purple-600 hover:text-purple-800 font-semibold">
                        Forgot Password?
                    </a>
                </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('consultation.index') }}" class="text-purple-600 hover:text-purple-800 font-semibold">
                        Book Consultation
                    </a>
                </p>
            </div>
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-purple-900 bg-opacity-30 px-4 py-2 rounded-lg">
                ...
                <p class="text-purple-100 text-xs">
                    Secure patient portal • Your health data is protected
                </p>
            </div>
        </div>
    </div>
