...
<head>
    ...
    <title>Verify Email - DoctorOnTap</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-purple-200 mt-1 text-sm">Please verify your email to continue</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-gray-600 mt-2">
                    ...
                    <span class="font-semibold text-purple-600">{{ Auth::guard('patient')->user()->email }}</span>
                </p>
            </div>
            ...
            <!-- Resend Verification -->
            <form method="POST" action="{{ route('patient.verification.resend') }}" class="mb-4">
                @csrf
                <button type="submit" 
