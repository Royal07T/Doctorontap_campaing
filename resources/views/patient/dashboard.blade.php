    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <section class="bg-rose-50 rounded-2xl p-6 border border-rose-100">
                ...
                <a href="tel:112" class="w-full flex items-center justify-center gap-2 py-3 bg-white border-2 border-rose-500 text-rose-600 rounded-xl text-xs font-black shadow-lg shadow-rose-100 hover:bg-rose-500 hover:text-white transition-all uppercase tracking-widest">
