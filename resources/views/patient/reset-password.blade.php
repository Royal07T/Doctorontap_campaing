...
<head>
    ...
    <title>Reset Password - DoctorOnTap Patient</title>
...
<body class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false, showPasswordConfirmation: false }">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-purple-200 mt-1 text-sm">Enter your new password below</p>
        </div>
            ...
            <form method="POST" action="{{ route('patient.password.update') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" 
                           value="{{ $email }}"
                           disabled
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed">
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-purple-900 bg-opacity-30 px-4 py-2 rounded-lg">
                ...
                <p class="text-purple-100 text-xs">
                    Secure password reset • Link expires in 60 minutes
                </p>
            </div>
        </div>
    </div>
