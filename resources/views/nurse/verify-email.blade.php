...
<head>
    ...
    <title>Verify Email - Nurse</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-purple-100 mt-1 text-sm">Nurse Portal</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-xs text-gray-500">
                    Email: <strong>{{ Auth::guard('nurse')->user()->email }}</strong>
                </p>
            </div>

            <!-- Resend Button -->
            <form method="POST" action="{{ route('nurse.verification.resend') }}">
                @csrf
                <button type="submit" 
