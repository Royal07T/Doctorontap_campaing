...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0"
            ...
            <!-- Sidebar Header -->
            <div class="pink-gradient p-5 flex items-center justify-between">
            ...
            <!-- User Info -->
            <div class="p-5 border-b border-gray-200 bg-gradient-to-r from-pink-50 to-indigo-50">
                <div class="flex items-center space-x-3">
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('nurse.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 text-white pink-gradient rounded-lg font-medium transition-all">
                ...
                <a href="{{ url('/') }}" target="_blank" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-pink-50 rounded-lg font-medium transition-all hover:text-pink-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <!-- Top Header -->
            <header class="pink-gradient shadow-lg z-10">
                <div class="flex items-center justify-between px-6 py-6">
                    <div class="flex items-center space-x-4">
                        <button @click="sidebarOpen = true" class="lg:hidden text-white hover:text-pink-200 focus:outline-none">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-pink-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-gray-600 text-xs font-medium uppercase tracking-wide mb-2">Total Consultations</p>
                                <p class="text-3xl font-bold text-pink-600">{{ $stats['total_consultations'] }}</p>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
                    <div class="max-w-2xl mx-auto">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 mb-2">Welcome, {{ Auth::guard('nurse')->user()->name }}!</h2>
                        <p class="text-gray-600">You're logged in to your nurse dashboard. More features will be available soon.</p>
                    </div>
                </div>
            </main>
        </div>
