...
<head>
    ...
    <title>Reset Password - DoctorOnTap Nurse</title>
...
<body class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false, showPasswordConfirmation: false }">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-purple-200 mt-1 text-sm">Enter your new nurse password below</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <!-- Reset Password Form -->
            <form method="POST" action="{{ route('nurse.password.update') }}">
                @csrf
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('nurse.login') }}" class="text-purple-600 hover:text-purple-800 font-semibold">
                        Back to Login
                    </a>
                </p>
            </div>
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-purple-900 bg-opacity-30 px-4 py-2 rounded-lg">
                ...
                <p class="text-purple-100 text-xs">
                    Secure nurse area • Your password will be updated immediately
                </p>
            </div>
        </div>
    </div>
