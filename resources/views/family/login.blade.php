...
<body class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false, pageLoading: false }">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-teal-200 mt-1 text-sm">View your loved one's care updates</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <form method="POST" action="{{ route('family.login.post') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email"
                           ...
                           required
                           autofocus
                           placeholder="family@doctorontap.com"
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-100 @error('email') border-red-500 @enderror">
                    @error('email')
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input :type="showPassword ? 'text' : 'password'"
                               ...
                               class="w-full px-4 py-2.5 pr-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-100 @error('password') border-red-500 @enderror">
                        <button type="button"
                ...
                <!-- Submit Button -->
                <button type="submit"
                        class="w-full px-6 py-3 teal-gradient text-white font-semibold text-sm rounded-lg hover:shadow-lg hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2">
            ...
            <div class="mt-5 pt-4 border-t border-gray-200 text-center">
                <a href="{{ url('/') }}" class="text-xs text-teal-600 hover:text-teal-800 font-semibold inline-flex items-center gap-1">
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-teal-900 bg-opacity-30 px-4 py-2 rounded-lg">
    ...
    <script>
        document.addEventListener('submit', function(e) {
            const form = e.target;
            if (form && form.tagName === 'FORM' && form.action.includes('/family/login')) {
                if (typeof Alpine !== 'undefined') {
                    const body = Alpine.$data(document.body);
                    if (body) { body.pageLoading = true; }
                }
            }
        });
    </script>
