...
<head>
    ...
    <title>Customer Care Login - DoctorOnTap</title>
...
<body class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false }">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-white">Customer Care Portal</h1>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('customer-care.login.post') }}">
                @csrf
                ...
                <div class="mb-5 flex items-center justify-between">
                    ...
                    <a href="{{ route('customer-care.password.request') }}" class="text-xs text-purple-600 hover:text-purple-800 font-semibold">
                        Forgot Password?
                    </a>
                </div>
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-purple-900 bg-opacity-30 px-4 py-2 rounded-lg">
                ...
                <p class="text-purple-100 text-xs">
                    Secure customer care area • All activities are logged
                </p>
            </div>
        </div>
    </div>
