...
<head>
    ...
    <title>Reset Password - DoctorOnTap Customer Care</title>
...
<body class="min-h-screen flex items-center justify-center px-4" x-data="{ showPassword: false, showPasswordConfirmation: false }">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-purple-200 mt-1 text-sm">Enter your new customer care password below</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <!-- Reset Password Form -->
            <form method="POST" action="{{ route('customer-care.password.update') }}">
                @csrf
                ...
                <!-- Confirm Password -->
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">
                    ...
                    <div class="relative">
                        <input :type="showPasswordConfirmation ? 'text' : 'password'" 
                               ...
                               class="w-full px-4 py-2.5 pr-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-100 @error('password_confirmation') border-red-500 @enderror">
                        <button type="button" 
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('customer-care.login') }}" class="text-purple-600 hover:text-purple-800 font-semibold">
                        Back to Login
                    </a>
                </p>
            </div>
        ...
        <div class="mt-4 text-center">
            <div class="inline-flex items-center gap-2 bg-purple-900 bg-opacity-30 px-4 py-2 rounded-lg">
                ...
                <p class="text-purple-100 text-xs">
                    Secure customer care area • Your password will be updated immediately
                </p>
            </div>
        </div>
    </div>
