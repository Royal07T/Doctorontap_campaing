                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-20 text-center">
                            ...
                            <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-2 mb-4">The support queue is currently clear</p>
                            <div class="flex items-center justify-center space-x-3">
                                @if(request()->hasAny(['search', 'status', 'category', 'priority']))
                                <a href="{{ route('customer-care.tickets.index') }}" class="px-6 py-2 bg-slate-100 text-slate-600 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-200 transition-all">
                                    Clear Filters
                                </a>
                                @endif
                                <a href="{{ route('customer-care.tickets.create') }}" class="px-6 py-2 bg-purple-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-purple-700 transition-all">
                                    Create New Ticket
                                </a>
                            </div>
                        </td>
