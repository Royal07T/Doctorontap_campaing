@php
    ...
    $titles = [
        ...
        'customer-care.prospects.index' => ['title' => 'Prospects', 'subtitle' => 'Lead Management'],
        'customer-care.prospects.create' => ['title' => 'Add Prospect', 'subtitle' => 'Silent Lead Capture'],
        'customer-care.prospects.show' => ['title' => 'Prospect Details', 'subtitle' => 'View Prospect'],
        'customer-care.prospects.edit' => ['title' => 'Edit Prospect', 'subtitle' => 'Update Prospect'],
        'customer-care.prospects.convert' => ['title' => 'Convert Prospect', 'subtitle' => 'Convert to Patient'],
        'customer-care.booking.create' => ['title' => 'Book Service', 'subtitle' => 'Book Consultation on Behalf'],
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    ...
                    <div x-show="open" 
                         ...
                         style="display: none;">
                        <a href="{{ route('customer-care.settings') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                            <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            <span class="font-medium">Profile</span>
                        </a>
                        <a href="{{ route('customer-care.settings') }}#preferences" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                            <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                            </svg>
                            <span class="font-medium">Preferences</span>
                        </a>
                        <a href="{{ route('customer-care.settings') }}#security" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                            <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
