...
<aside class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-right border-gray-200 shadow-xl transform transition-transform duration-500 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col"
    ...
    <!-- Navigation (Scrollable) -->
        ...
        <!-- Prospects -->
        <a href="{{ route('customer-care.prospects.index') }}" class="flex items-center space-x-3 px-4 py-3.5 {{ request()->routeIs('customer-care.prospects*') ? 'bg-purple-600 text-white shadow-lg shadow-purple-200' : 'text-slate-600 hover:text-purple-600 hover:bg-purple-50' }} rounded-2xl font-bold transition-all duration-300 group">
    ...
    <div class="px-6 py-4 border-t border-slate-100 bg-white flex-shrink-0">
        <!-- View Website -->
        <a href="{{ url('/') }}" target="_blank" class="flex items-center justify-between px-4 py-3 text-slate-600 hover:text-purple-600 hover:bg-purple-50 rounded-2xl font-bold transition-all group">
        ...
        <!-- Settings -->
        <a href="{{ route('customer-care.settings') }}" class="flex items-center justify-between px-4 py-3 text-slate-600 hover:text-purple-600 hover:bg-purple-50 rounded-2xl font-bold transition-all group mt-2">
            <div class="flex items-center space-x-3 text-xs">
            ...
            <svg class="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
        </a>
    </div>
</aside>
