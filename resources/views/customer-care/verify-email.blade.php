...
<head>
    ...
    <title>Verify Email - Customer Care</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-purple-100 mt-1 text-sm">Customer Care Portal</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-xl p-6">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-xs text-gray-500">
                    Email: <strong>{{ Auth::guard('customer_care')->user()->email }}</strong>
                </p>
            </div>

            <!-- Resend Button -->
            <form method="POST" action="{{ route('customer-care.verification.resend') }}">
                @csrf
                <button type="submit" 
            ...
            <div class="mt-4 text-center">
                <form method="POST" action="{{ route('customer-care.logout') }}" class="inline">
                    @csrf
