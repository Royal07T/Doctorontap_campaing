...
<head>
    ...
    <title>Customers - Customer Care</title>
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                    <form method="GET" action="{{ route('customer-care.customers.index') }}" class="flex gap-4">
                        ...
                        <div>
                            <a href="{{ route('customer-care.customers.index') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                                Clear
                            </a>
                        </div>
                        @endif
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                                            {{ $customer->customer_interactions_count }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-800">
                                            {{ $customer->consultations_count }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('customer-care.customers.show', $customer) }}" class="text-purple-600 hover:text-purple-900">View Profile</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
