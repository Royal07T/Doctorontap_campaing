...
<head>
    ...
    <title>Care Giver Login – {{ config('app.name') }}</title>
...
<div class="reg-shell">
    ...
    <aside class="reg-image-panel">
        <img src="{{ asset('img/Stethoscope wallpaper for doctors.jpeg') }}" alt="Care Giver login" loading="eager">
        ...
        <div class="reg-image-content">
            ...
            <div>
                <h1 style="font-size:2.25rem;font-weight:800;color:#fff;line-height:1.2;letter-spacing:-0.02em;margin:0 0 0.875rem;">
                    Welcome back,<br>
                    <span style="color:#c4b5fd;">Care Giver</span>
                </h1>
                <p style="font-size:1rem;color:rgba(255,255,255,0.75);margin:0 0 2.5rem;line-height:1.6;max-width:22rem;">
                    Access your secure portal to support patients, manage assignments, and deliver quality care.
                </p>
    ...
    <div class="reg-form-panel">
        <header class="reg-topbar">
            ...
            <a href="{{ route('caregiver.register') }}" class="reg-topbar-btn">
                Need an account?
        ...
        <div class="reg-mobile-hero">
            <div class="reg-mobile-hero-badge">
                ...
                Secure Care Giver Portal
            </div>
            <h1>Care Giver Login</h1>
            <p>Sign in to access your dashboard and assigned patients.</p>
                ...
                <div class="login-card">
                    ...
                    @if(session('verification_required'))
                        <div class="mb-6 p-4 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl text-sm">
                            ...
                            <p class="mt-1 text-amber-700">Please check your email ({{ session('verification_email') }}) and click the verification link to activate your account.</p>
                        </div>
                    @endif

                    <form method="POST" action="{{ route('care_giver.login.post') }}" @submit="isSubmitting = true">
                        @csrf

                        <div class="mb-5">
                            <label for="email" class="form-label">Email Address</label>
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="caregiver@doctorontap.com" class="form-control @error('email') border-red-500 @enderror">
...
<x-system-preloader x-show="isSubmitting" message="Signing in..." />
