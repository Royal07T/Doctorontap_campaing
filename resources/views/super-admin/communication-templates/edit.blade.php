...
<head>
    ...
    <title>Edit Template - Super Admin</title>
...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false, channel: '{{ $communicationTemplate->channel }}', body: @js($communicationTemplate->body), detectedVars: [] }" 
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            @include('super-admin.shared.header', ['title' => 'Edit Communication Template'])

            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                <div class="max-w-4xl mx-auto">
                    <div class="mb-6">
                        <a href="{{ route('super-admin.communication-templates.show', $communicationTemplate) }}" 
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h2 class="text-xl font-bold text-gray-900 mb-6">Edit Template</h2>

                        <form method="POST" action="{{ route('super-admin.communication-templates.update', $communicationTemplate) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="body" x-model="body" rows="8" required
                                              ...
                                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent font-mono text-sm">@{{ old('body', $communicationTemplate->body) }}</textarea>
