...
<head>
    ...
    <title>Communication Templates - Super Admin</title>
...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            @include('super-admin.shared.header', ['title' => 'Communication Templates'])
            ...
            <main class="flex-1 overflow-y-auto bg-gray-100 p-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <form method="GET" action="{{ route('super-admin.communication-templates.index') }}" class="flex flex-wrap gap-4 flex-1">
                            ...
                            <a href="{{ route('super-admin.communication-templates.index') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">
                                Clear
                            </a>
                            @endif
                        </form>
                        <a href="{{ route('super-admin.communication-templates.create') }}" 
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="{{ route('super-admin.communication-templates.show', $template) }}" 
                                               class="text-purple-600 hover:text-purple-900">View</a>
                                            <a href="{{ route('super-admin.communication-templates.edit', $template) }}" 
                                               class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                            <form method="POST" action="{{ route('super-admin.communication-templates.toggle-status', $template) }}" class="inline">
                                                @csrf
                                                <button type="submit" class="text-amber-600 hover:text-amber-900">
                                                    {{ $template->active ? 'Deactivate' : 'Activate' }}
                                                </button>
                                            </form>
                                            <form method="POST" action="{{ route('super-admin.communication-templates.destroy', $template) }}" 
